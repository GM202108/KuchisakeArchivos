...
<div class="EscenaFondo6 container-xxl">
    <img class=" position-absolute Anm8" src="./Imagenes/IMG-Escenas/Esc6.png" alt="">
    <div class=" position-absolute Esc6x"></div>
...
<script src=<?php echo baseUrl . './JavaScript/Escena66.js'; ?>></script>